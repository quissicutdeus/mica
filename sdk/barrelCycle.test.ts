...
import { useService, usePersisted, useAppEvents } from '@mica/sdk';
import { useNuiBridge } from '@mica/sdk/core';

/**
 * The SDK barrel must be importable from a module that runs early.
 *
 * It was not, and the cycle was this: `@mica/sdk` re-exports `useAppRegistry`, which
 ...
 *
 * `@mica/sdk/app` fixed it by being a leaf a manifest can import without pulling
