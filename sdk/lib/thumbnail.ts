 ...
 * itself through `@mica/sdk`. `lib/` is state-free and I/O-free by definition
 ...
 * `mica_camera_quality` and defaults to 0.95, and `THUMBNAIL_QUALITY` for the small
 ...
 * `mica_camera_quality` says (0.95 unless a server owner turned it down). This number
