 ...
 * `@mica/sdk` and nothing else, so a helper reachable only at `../../utils/` does not
 ...
 * becomes script.
 */
export { tokenizeRichText } from '@mica/shared/richText';
 ...
 * thing as everything above: DOM behaviour with no micaOS state behind it, implemented in
