...
export const LICENSE_WARRANTY =
  'gPhone is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; ' +
  'without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.';

export const LICENSE_FREEDOMS =
  'gPhone is free software. You may redistribute and modify it under the terms of the GNU ' +
...
export const MICA_SOURCE_URL = 'https://github.com/quissicutdeus/gPhone';
 ...
 * works.
 *
 * `base` is the operator's own repository once `gphone_source_url` reaches this (still to
