...
/**
 * Centralized micaOS Versioning & Smart Build Information
 *
...
/**
 * The version of the **contract** `@mica/sdk` publishes: the exported names of each entry
 ...
 */
export const MICA_VERSION: string = typeof __MICA_VERSION__ !== 'undefined' ? __MICA_VERSION__ : '';
 ...
 */
export const MICA_BRANCH: string = typeof __MICA_BRANCH__ !== 'undefined' ? __MICA_BRANCH__ : '';
