...
const TARGET_ENTRIES = [
  {
    // MICA-112, MICA-199: FXServer's server-side JS runtime defaults to Node 16, and
    // the opt-in alternative is Node 22 via a `node_version '22'` directive in fxmanifest.lua
    // (docs.fivem.net/docs/scripting-reference/resource-manifest/). This repo now declares
    // that directive, generated by scripts/generate-barrels.js, so it runs on Node 22.
    target: "node22",
