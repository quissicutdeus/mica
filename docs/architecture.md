...
| `mica.sql`                     | generated    | The whole schema from `pnpm generate:sql`; imported by hand                               |
...
| `sdk/`                         | CEF+browser  | `@mica/sdk` — the public surface for apps (AGENTS.md §2.7)                                |
...
| `web/src/lib/`                 | CEF+browser  | Helpers with no micaOS state and no I/O — formatters, markdown                            |
