 ...
 * (`gphone:client:shell:notify`, `gphone:client:shell:appEvent`), and `server/lib/shell.ts`
 ...
 */
export const MUSIC_BROADCAST_NET_EVENT = 'gphone:client:shell:music';

/**
 * Metres. What `gphone_music_range` defaults to when a server sets nothing.
 *
...
/**
 * The ceiling `gphone_music_max_nearby` cannot be raised past.
 *
 ...
 *
 * A separate namespace from net events, so no `gphone:` prefix (AGENTS.md §8) — and named
