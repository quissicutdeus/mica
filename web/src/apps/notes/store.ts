...
import { createCrudStore, byNewest, useService } from '@mica/sdk';
 ...
 * `@mica/sdk` barrel was still initialising, the imports came back `undefined`
 * (`byNewest is not a function`). `@mica/sdk/app` fixed that at the source: a manifest
