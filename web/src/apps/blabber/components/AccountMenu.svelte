...
<script lang="ts">
  import { Avatar, CheckIcon, useLocale } from '@mica/sdk';
   ...
   * allowed `mica_max_accounts_per_app` identities (three by default) while `ClaimHandle`
   ...
   * the bottom because a phone is tall and a thumb lives down there. micaOS is a mouse-driven
