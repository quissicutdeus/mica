...
const BASELINE: Record<string, number> = {
  'web/src/apps/admin/index.svelte': 10,
  ...
  'web/src/apps/blabber/components/AccountMenu.svelte': 4,
  'web/src/apps/blabber/components/BlabActions.svelte': 1,
  'web/src/apps/blabber/components/BlabDetail.svelte': 4,
  'web/src/apps/blabber/components/BlabRow.svelte': 9,
  'web/src/apps/blabber/components/ClaimHandle.svelte': 4,
  'web/src/apps/blabber/components/Composer.svelte': 6,
  'web/src/apps/blabber/components/EditProfile.svelte': 6,
  'web/src/apps/blabber/components/Messages.svelte': 4,
  'web/src/apps/blabber/components/NotificationsTab.svelte': 2,
  'web/src/apps/blabber/components/Profile.svelte': 9,
  'web/src/apps/blabber/components/Search.svelte': 10,
  ...
  'web/src/apps/snek/GameOverModal.svelte': 5,
  'web/src/apps/snek/Hud.svelte': 2,
  'web/src/apps/snek/Leaderboard.svelte': 4,
  'web/src/apps/snek/index.svelte': 10,
  'web/src/apps/store/components/AppDetails.svelte': 16,
  'web/src/apps/store/components/CatalogList.svelte': 3,
  'web/src/apps/store/components/InstalledList.svelte': 13,
  'web/src/apps/store/index.svelte': 19,
  'web/src/shell/AppCrashed.svelte': 5,
  'web/src/shell/AppDrawer.svelte': 5,
  'web/src/shell/Dock.svelte': 2,
  'web/src/shell/FolderPopup.svelte': 1,
  'web/src/shell/Launcher.svelte': 2,
  'web/src/shell/LockScreen.svelte': 5,
  'web/src/shell/MusicPlayer.svelte': 1,
  'web/src/shell/NearbyMusic.svelte': 3,
  'web/src/shell/NotNetworkScreen.svelte': 2,
  'web/src/shell/NotificationShade.svelte': 31,
  'web/src/shell/NowPlaying.svelte': 1,
  'web/src/shell/PhoneFrame.svelte': 8,
  'web/src/shell/RemoveTarget.svelte': 1,
  'web/src/shell/Search.svelte': 2,
  'web/src/shell/Shell.svelte': 1,
  'web/src/shell/ToastHost.svelte': 3,
  'web/src/shell/addon/AddOnFrame.svelte': 1,
