 ...
 * authenticated (`server/lib/ServerApp.ts`), and the client sends it when a request goes
 * unanswered for 15 seconds (`client/lib/ClientApp.ts`). All three are failures wearing
 * the shape of data.
 */
