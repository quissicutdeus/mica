...
// MICA-172: a relative path rather than `@mica/sdk/app.css`, deliberately. Vite's
// string aliases match by prefix, so `@mica/sdk/app.css` would hit the `@mica/sdk/app`
