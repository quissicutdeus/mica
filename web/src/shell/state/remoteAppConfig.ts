...
import { parseRemoteAppConfig, type RemoteAppConfigPayload } from '@mica/shared/nui';
 ...
 * from `@mica/sdk` — and had no caller outside a unit test (MICA-126). With an empty
