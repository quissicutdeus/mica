...
>
  <div
    class="h-14 w-14 rounded-lg {color} shadow-elevation-3 relative flex cursor-pointer items-center justify-center transition-transform group-hover:scale-105 group-active:scale-95"
  >
