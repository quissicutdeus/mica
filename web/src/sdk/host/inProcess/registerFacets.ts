 ...
 * a build alias: every `useXxx.ts` hook opened with `import './inProcess/facets/<name>';`
 ...
 * `import type { Facets } from './facets'`. This file is the opposite — 46 of the 48
 ...
 * `audio.ts`'s `import { usePersisted } from '.../usePersisted'` *was* the guarantee that
