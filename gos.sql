...
CREATE TABLE IF NOT EXISTS `gos_accounts` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_account_follows` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_gos_account_follows_follower_account_id` FOREIGN KEY (`follower_account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_account_follows_followee_account_id` FOREIGN KEY (`followee_account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_account_blocks` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_gos_account_blocks_blocker_account_id` FOREIGN KEY (`blocker_account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_account_blocks_blocked_account_id` FOREIGN KEY (`blocked_account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_account_reactions` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    KEY `target` (`target_table`, `target_id`),
    CONSTRAINT `fk_gos_account_reactions_account_id` FOREIGN KEY (`account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_battery` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_blabber_dms` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    ...
    CONSTRAINT `fk_gos_blabber_dms_from_account` FOREIGN KEY (`from_account`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_dms_to_account` FOREIGN KEY (`to_account`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `gos_blocklist` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    ...
    CONSTRAINT `fk_blocklist_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_contacts` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_messages_conversations` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_messages_participants` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_gos_messages_participants_conversation_id` FOREIGN KEY (`conversation_id`)
        REFERENCES `gos_messages_conversations` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_messages_participants_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_highscores` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    `app` varchar(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_hodlr` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_hodlr_price_history` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `gos_lockscreen` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    ...
    KEY `citizenid_status` (`citizenid`, `status`),
    UNIQUE KEY `citizenid_unique` (`citizenid`),
    CONSTRAINT `fk_lockscreen_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_mail` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_media` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_blabber` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    `account_id` int(11) NOT NULL,
    ...
    CONSTRAINT `fk_gos_blabber_account_id` FOREIGN KEY (`account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_reply_to` FOREIGN KEY (`reply_to`)
        REFERENCES `gos_blabber` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_mouth_of` FOREIGN KEY (`mouth_of`)
        REFERENCES `gos_blabber` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_root_id` FOREIGN KEY (`root_id`)
        REFERENCES `gos_blabber` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_blabber_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_blabber_ears` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    KEY `account_id` (`account_id`),
    CONSTRAINT `fk_gos_blabber_ears_blab_id` FOREIGN KEY (`blab_id`)
        REFERENCES `gos_blabber` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_ears_account_id` FOREIGN KEY (`account_id`)
        REFERENCES `gos_accounts` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_blabber_tags` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `blab_id` int(11) NOT NULL,
    ...
    KEY `tag` (`tag`),
    KEY `blab_id` (`blab_id`),
    CONSTRAINT `fk_gos_blabber_tags_blab_id` FOREIGN KEY (`blab_id`)
        REFERENCES `gos_blabber` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_blabber_attachments` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `blab_id` int(11) NOT NULL,
    `citizenid` varchar(50) NOT NULL,
    ...
    CONSTRAINT `fk_gos_blabber_attachments_blab_id` FOREIGN KEY (`blab_id`)
        REFERENCES `gos_blabber` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_attachments_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_blabber_attachments_media_id` FOREIGN KEY (`media_id`)
        REFERENCES `gos_media` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

-- Generated from the 'marketplace' defineService declaration.
-- Do not edit by hand; change the declaration and regenerate.

CREATE TABLE IF NOT EXISTS `gos_marketplace` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_marketplace_attachments` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    KEY `citizenid` (`citizenid`),
    KEY `media_id` (`media_id`),
    CONSTRAINT `fk_gos_marketplace_attachments_listing_id` FOREIGN KEY (`listing_id`)
        REFERENCES `gos_marketplace` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_marketplace_attachments_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_marketplace_attachments_media_id` FOREIGN KEY (`media_id`)
        REFERENCES `gos_media` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_messages` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    `conversation_id` int(11) NOT NULL,
    ...
    CONSTRAINT `fk_gos_messages_conversation_id` FOREIGN KEY (`conversation_id`)
        REFERENCES `gos_messages_conversations` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_messages_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_messages_attachments` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `fk_gos_messages_attachments_message_id` FOREIGN KEY (`message_id`)
        REFERENCES `gos_messages` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_messages_attachments_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_messages_attachments_photo_id` FOREIGN KEY (`photo_id`)
        REFERENCES `gos_media` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `gos_messages_reactions` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `message_id` int(11) NOT NULL,
    `citizenid` varchar(50) NOT NULL,
    `emoji` varchar(32) NOT NULL,
    ...
    KEY `message_id` (`message_id`),
    CONSTRAINT `fk_gos_messages_reactions_message_id` FOREIGN KEY (`message_id`)
        REFERENCES `gos_messages` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_gos_messages_reactions_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_notes` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_notifications` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    `app` varchar(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_phone_call_log` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_phone_numbers` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_places` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    ...
    KEY `status` (`status`),
    KEY `citizenid_status` (`citizenid`, `status`),
    CONSTRAINT `fk_places_citizenid` FOREIGN KEY (`citizenid`)
        REFERENCES `players` (`citizenid`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `gos_reports` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    `target_table` varchar(64) NOT NULL,
    `target_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_settings` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `citizenid` varchar(50) NOT NULL,
    `app` varchar(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gos_schema_migrations` (
    `id` varchar(255) NOT NULL,
    `applied_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

INSERT IGNORE INTO `gos_schema_migrations` (`id`) VALUES
